/**
 * Push updated CLAUDE.local.md + gate script into the live ai-life-coach agent
 * group and its running recurring task.
 *
 * Usage: pnpm exec tsx scripts/update-life-coach.ts
 */
import fs from 'fs';
